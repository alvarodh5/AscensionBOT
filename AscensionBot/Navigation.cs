...
namespace AscensionBot
{
    public unsafe class Navigation
    {
        ...
        static public Position[] CalculatePath(uint mapId, Position start, Position end, bool straightPath)
        {
            ...
            {
                // No mmaps generated for this map -> the native pathfinder throws (SEHException).
                // Fall back to a straight line so movement still works on open terrain.
                return new[] { start, end };
            }
        }
